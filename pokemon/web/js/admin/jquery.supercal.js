	...
	$.fn.supercal = function(method) {
		...
		var pMethods = {
			...
			drawHeader: function(date, options) {
				...
				$('<button />')
					.addClass('prev-month change-month btn btn-primary')
					.html('&laquo;')
					.appendTo(header);

				$('<button />')
					.addClass('next-month change-month btn btn-primary')
					.html('&raquo;')
					.appendTo(header);
			...
			drawFooter: function(date, options) {
				...
				if(options.todayButton) {
					$('<button />')
						.text('Today')
						.addClass('btn btn-primary supercal-today')
						.attr('type', 'button')
						.appendTo(footer);
				}
				...
				if(!$(document).data('supercal-events')) {
					$(document).on('click.supercal', '.supercal .change-month', function(e) {
						...
						.on('click.supercal', '.supercal table.current td', function() {
							...
							if(options.showInput) {
								container.find('.supercal-input').change();
							}
